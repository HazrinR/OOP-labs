...
public class Lab3 {
    ...
    {DataStructures taskManager = new DataStructures();
        ...
        System.out.println("\nTasks with ID >= 2:");
        taskManager.getTaskByIDGreaterOrEqual(2).forEach(task -> System.out.println(task.getTaskDescription()));

        System.out.println("\nTask Descriptions:");
        taskManager.printTaskDescription();
    }
    ...
    class DataStructures {
        ...
        public List<TaskItem> getTaskByIDGreaterOrEqual(int id)
...
class DbConnect {
    ...
    private static final String PASSWORD = "hazrin123";
